## Man page for the Nagios plugin check_dbversion_sybase
...
Version OK: Adaptive Server Enterprise v15.7 ase157sp101, 3439|</pre>
...
`Adaptive Server Enterprise/15.7/EBF 21338 SMP SP101 /P/NT (IX86)/Windows 2008 R2/ase157sp101/3439/32-bit/OPT/Thu Jun 06 12:02:54 2013`

The plugin's .java source code file needs to be compiled into Java bytecode before it can be used, i.e. by calling:  
_javac check_dbversion_sybase.java_.
